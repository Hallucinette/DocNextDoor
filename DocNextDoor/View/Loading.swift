    ...
    var body: some View {
        ZStack { //background
            ...
            VStack {
                ...
                Text("Des opportunités pour lutter contre les déserts médicaux !").font(.title3).italic().multilineTextAlignment(.center).foregroundColor(Color(.white)).frame(width: 300)

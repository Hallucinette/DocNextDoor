...
struct AdPublished: View {
    var body: some View {
        //NavigationLink(destination : ManageAds().navigationBarHidden(true).navigationBarBackButtonHidden(true)) {}
        ZStack { //background
            ...
            VStack {
                ...
                Text("Bientôt le candidat fait pour vous !").font(.title3).italic().multilineTextAlignment(.center).foregroundColor(Color("Txtgrey")).frame(width: 350)
